$(function(){
	...
	$("#MENU li").hover(function(){
		...
		$(this).stop(true,false).animate({marginTop:40},800,"easeOutBounce");	
		$(this).next().stop(true,false).animate({marginTop:40},700,"easeOutBounce");
		$(this).prev().stop(true,false).animate({marginTop:40},700,"easeOutBounce");
	});
